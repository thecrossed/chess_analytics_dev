import type { CoachClass, CoachStudentLink, ConnectionRequest, Puzzle, PuzzleAssignment, StoredPuzzleState, Student, UserAccount } from "../types";
...
type PersistedAppState = {
  ...
  coachStudentLinks?: CoachStudentLink[];
