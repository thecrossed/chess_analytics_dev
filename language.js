...
const TRANSLATIONS = {
  en: {
    ...
    home_pgn_invalid_format: "Invalid PGN format. Please check PGN text and try again.",
  ...
  fr: {
    ...
    home_pgn_invalid_format: "Format PGN invalide. Vérifiez le texte PGN et réessayez.",
  ...
  zh: {
    ...
    home_pgn_invalid_format: "PGN 格式无效，请检查后重试。",
  ...
  es: {
    ...
    home_pgn_invalid_format: "Formato PGN no válido. Revisa el texto PGN y vuelve a intentarlo.",
  ...
  sv: {
    ...
    home_pgn_invalid_format: "Ogiltigt PGN-format. Kontrollera PGN-texten och försök igen.",
